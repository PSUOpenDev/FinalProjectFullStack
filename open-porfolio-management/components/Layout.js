...
const Layout = ({ children }) => {
  ...
  const [formOpen, setFromOpen] = React.useState(false)
    ...
    <div>
      ...
      <AppBar position="static">
          <Toolbar>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              ...
              >
                {isSignedIn ? (
                  <Icon>
                    <img sx={{ width: 4 }} src={getProfilePicUrl()} />
                  </Icon>
                ) : (
                  <AccountCircle />
                )}
        ...
        >
          ...
          <Divider />
          <List>
          <ListItem button  onClick={()=>setFromOpen(true)} >
              <ListItemIcon>
                <InboxIcon /> 
              </ListItemIcon>
        ...
        <Main open={open}>
          ...
          <FromAddStock formOpen={formOpen} onCloseDialog = {setFromOpen} />
        {renderMobileMenu}
        {renderMenu}
      </Box>
    </div>
